...
from .swin_transformer_lora import interpolate_relative_pos_embed
...
def init_tokenizer():
    ...
    tokenizer = BertTokenizer.from_pretrained('src/ram_pretrain_model/bert-base-uncased', local_files_only=True)
