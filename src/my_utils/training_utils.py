...
def parse_args(input_args=None):
    ...
    parser.add_argument("--tracker_project_name", type=str, default="focus-sr")
    ...
    parser.add_argument("--enable_pixel_stage_perceptual_losses", type=str2bool, default=False)
    parser.add_argument("--consistency_aug", default="hflip", choices=["hflip"], type=str)
    parser.add_argument("--consistency_space", default="semantic_delta", choices=["semantic_delta"], type=str)
    parser.add_argument("--pixel_rank_curriculum_json", type=str, default=None)
    parser.add_argument("--semantic_rank_curriculum_json", type=str, default=None)
    parser.add_argument("--sequential_semantic_lora_curriculum_json", type=str, default=None)
    parser.add_argument(
        "--semantic_train_phase",
        type=str,
        default="legacy",
        choices=["legacy", "detail", "safe", "both", "stage2a", "stage2b", "low_conflict", "high_conflict"],
    )
    parser.add_argument("--enable_layer_diagnostic_logging", type=str2bool, default=False)
    parser.add_argument("--layer_diagnostic_freq", type=int, default=500)
    parser.add_argument("--layer_diagnostic_start_step", type=int, default=1)
    parser.add_argument("--layer_diagnostic_objectives", type=str, default="l2,lpips,csd")
    ...
    # dataset options
    parser.add_argument("--dataset_txt_paths", default='preset/gt_all_path.txt', type=str)
    parser.add_argument("--highquality_dataset_txt_paths", default='preset/gt_hq_path.txt', type=str)
    ...
    parser.add_argument("--reset_semantic_lora_on_resume", type=str2bool, default=False)
    ...
    parser.add_argument("--deg_file_paths", default=None, type=str)
    parser.add_argument("--deg_preset_probs", default=None, type=str)
