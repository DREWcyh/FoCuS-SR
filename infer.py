...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_path', type=str, default='preset/models/focussr.pkl', help="path to a model state dict to be used")
